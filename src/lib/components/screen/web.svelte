...
<div class="web-theme flex min-h-screen flex-col bg-background text-foreground">
	<!-- Sticky Header -->
	<header
		class="fixed top-0 right-0 left-0 z-50 border-b transition-all duration-300 {isScrolled
			? 'border-gray-800 bg-background/90 py-3 backdrop-blur-md'
	...
	>
		<div class="container mx-auto flex items-center justify-between px-6">
			...
			>
				...
				<span class="hidden text-lg font-bold tracking-tight sm:block">두두타 피아노</span>
			</button>
