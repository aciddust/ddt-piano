...
export const APP_INFO = {
	version: version,
	downloadLink: `https://github.com/aciddust/ddt-piano/releases/download/v${version}/ddt-piano_${version}_x64-setup.exe`,
	...
	youtubeLink: 'https://youtu.be/n9UKOR-FdnA'
};
...
export const MIDI_SOURCES = [
	...
	},
	{
		...
		description:
			'1996년부터 비디오 게임 음악을 전문으로 하는 사이트입니다. 다양한 게임의 MIDI 파일을 제공합니다.'
	},
	{
		name: 'midex',
		url: 'https://midiex.net/',
		description:
			'아마추어 음악인 커뮤니티. 자작곡, 자작앨범 발매, 미디 자료 공유 등이 이루어지는 곳입니다.'
	},
	{
		name: 'bitmidi',
